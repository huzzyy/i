...
class productClass:
    def __init__(self,root):
      ...
      ##TITLE##
        ...
        title=Label(product_Frame,text="MANAGE PRODUCTS DETAILS",font=("goudy old style",20),bg="#0f4d7d",fg="white").pack(side=TOP,fill=X)
        
        ##COLUM 1#######
        lbl_cat=Label(product_Frame,text="Category",font=("goudy old style",18),bg="white").place(x=30,y=60)
   ...
   ##BOXES COLUM 2##
        ...
        cmb_cat.place(x=150,y=61,width=200)
        cmb_cat.current(0)
        ...
        searchframe.place(x=480,y=10,width=650,height=80)
...
##############TREEVIEW PRODUCT DETAIWLS######

        p_frame=Frame(self.root,bd=3,relief=RIDGE)
        p_frame.place(x=480,y=100,width=650,height=430)
...
#######################################################################FUNCTIONS$######
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_cat.get()=="Select" or self.var_cat.get()=="Empty" or self.var_supplier.get()=="Select" or self.var_name.get()=="":
