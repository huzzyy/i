...
class salesClass:
   ...
   ##TITLE##
       ...
       ##BILL LIST###         
        ...
        sales_frame.place(x=50,y=140,width=200,height=370)
      ...
      ##BILL AREA##
        ...
        bill_frame.place(x=280,y=140,width=571,height=370)    
    ...
    ##IMAGAESSS##            
        ...
        self.bill_photo=self.bill_photo.resize((300,250), resample=Image.BILINEAR)
        self.bill_photo=ImageTk.PhotoImage(self.bill_photo)
        
        lbl_image =Label(self.root,image=self.bill_photo,bd=0)
        lbl_image.place(x=900,y=150)
