...
class supplierclass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Supplier Details",font=("goudy old style",20,"bold"),bg="#0f4d7d",fg="white").place(x=70,y=10,width=1000,height=40)
        ...
        emp_frame.place(x=750,y=120,width=380,height=350)
